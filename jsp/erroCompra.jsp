...
<html lang="gl">
    ...
    <body class="container-fluid">
        ...
        <section class="row">
            <h1 class="col-12 titulo"> Lista de items problemáticos </h1> 
            <fmt:setLocale value="es_ES"/>
            <article class="col-sm-10 col-md-10 artigo">
                <h2> Mensaxe </h2>
                <p> Se estás aquí é porque a túa selección de artigos supera ao stock que temos.
                    Pedímoslle desculpas. Aquí pode retirar os artigos que non pode comprar e
                    volver ao carro por se quixer facer máis cambios </p>
            </article>

            <c:forEach var="artigo" items="${sessionScope.artigosProblematicos}">
                <article class="col-sm-10 col-md-10 artigo">
            ...
            <article class="col-sm-10 col-md-10 artigo">
                <form action="./compra" method="POST" name="artigo" class="form-botons">
                    <input type="hidden" name="opcion" value="quitarTodoArtigoProblematico">
                    <input type="submit" name="submit" value="Retirar a diferenza">
                </form>
            </article>
        </section>
